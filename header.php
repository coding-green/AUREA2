                        ...
                        <ul class="sub-menu">
                            <div class="d-flex flex-row">
                                <li>
                                    ...
                                    ?>
                                    <a href="product-listing.php?product_type_id=<?php echo $row['product_type_id']; ?>">
                                ...
                                <li class="active">
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                    ?>
                                    <a href="product-listing.php?skin_concern_id=<?php echo $row['skin_concern_id']; ?>">
                                ...
                                <li>
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                    ?>
                                    <a href="product-listing.php?skin_type_id=<?php echo $row['skin_type_id']; ?>">
                                ...
                                <li>
                                    <h5 class="sub-menu-heading overflow ">Popular Brands</h5>
                                    <?php
                                    $query = "SELECT * FROM Brands ORDER BY brands_name";
                                    $result = mysqli_query($conn, $query);
                                    while ($row = mysqli_fetch_array($result)) {
                                    ?>
                                    <a href="product-listing.php?brands_id=<?php echo $row['brands_id']; ?>">
                                        <?php echo $row['brands_name']; ?></a>
                                    <?php
                                    }
                                    ?>
                                </li>
